...
import { CollaborationItem } from '../components/data/Projects';
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:col-span-8 md:order-2">
              ...
              <p className="text-justify font-medium indent-10">
                Développeur Full Stack IA avec {experienceYears()} ans d&apos;expérience, je mets
                aujourd&apos;hui les LLM au cœur des produits métiers. Utilisateur quotidien de
                Claude Code, je pratique le vibe coding : orchestration d&apos;agents, context
                engineering avancé, cycle produit complet piloté par IA. Ma stack principale :
                React, TypeScript, Node.js, MongoDB, éprouvée sur des projets e-commerce à forte
                audience et sur mes propres applications avec intégration LLM (Anthropic, Gemini).
              </p>
              <p className="text-justify font-medium indent-10 my-4">
                Mon parcours est né chez Capgemini (2019-2023), où j&apos;ai contribué aux
                plateformes e-commerce du groupe L&apos;Oréal (Urban Decay, Kiehl&apos;s, YSL), Fast
                Retailing et Orchestra : diagnostic de bugs critiques en production, refonte de
                composants stratégiques, coordination d&apos;équipes offshore. J&apos;ai poursuivi
                chez Madagence (2023-2025) en intégrant mes premiers LLM dans les workflows métier :
                un outil React + API GPT pour automatiser l&apos;enrichissement des fiches produits
                Sisley, Neuraé et Haribo. J&apos;ai obtenu la certification Salesforce B2C Commerce
                Developer en 2023.
              </p>
              <p className="text-justify font-medium indent-10">
                En 2026, j&apos;ai livré trois applications from scratch avec intégration LLM en
                pilotant le cycle produit complet par IA : <strong>Dog Days</strong> (jeu 4X
                multijoueur web, Next.js, MongoDB, Redis, 1&nbsp;780+ tests),{' '}
                <strong>Commis</strong> (assistant pâtisserie IA sur Android, React Native, Gemini
                Flash) et <strong>Runova</strong> (app gamifiée Couch-to-5K, cycle produit en 14
                jours). Profil product-first, autonome, issu d&apos;une formation scientifique
                (Doctorat en Biothérapie Cellulaire et Tissulaire, UPMC 2018), je cherche
                aujourd&apos;hui un poste de développeur Full Stack IA ou un binôme CTO.
            ...
            <div className="col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3">
              ...
              <div className="flex flex-col items-end xl:items-center justify-center lg:mx-1 max-w-[12rem]">
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5l xs:text-4xl">
                  <AnimatedNumbers value={3} />{' '}
                </span>
                <h2 className="text-lg font-medium text-dark/75 dark:text-light/75 text-right xl:text-center md:text-base sm:text-sm xs:text-xs leading-tight">
                  Apps en production
                  <br />
                  en 2026
                </h2>
